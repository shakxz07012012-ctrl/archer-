...
class AnalogController {
    ...
    static injectCSS() {
        ...
        style.textContent = `
            ...
            .attack-btn-archer:active, .attack-btn-shuken:active {
                transform: scale(0.9);
            }
            ...
            @media (max-width: 600px) {
                ...
                .attack-btn-archer { width: 60px; height: 60px; font-size: 28px; bottom: 100px; right: 15px; }
...
class GameController {
    ...
    createControls() {
        ...
        if (this.heroType === "archer") {
            ...
            this.attackBtn.className = "attack-btn-archer";
